...
class Monthly_Consolidate_Refunds extends Consolidate {
  ...
  public function __construct ( $date = false ) {
    ...
    $this->set_columns ( );
    $this->set_report_name ( 'monthly_refunds' , $after );
  }
  ...
  public function backdate ( ) {
    ...
    $i = 0;
    do {
      $report = new Monthly_Consolidate_Refunds ( $first_order_date );
